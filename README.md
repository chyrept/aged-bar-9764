...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aged-bar-9764
```

A live public deployment of this template is available at [https://aged-bar-9764.templates.workers.dev](https://aged-bar-9764.templates.workers.dev)
